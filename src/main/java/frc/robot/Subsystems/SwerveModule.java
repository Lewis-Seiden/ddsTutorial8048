...
public class SwerveModule {
    ...
    public void setDriveVelocity(double metersPerSecond) {
        double rotationsPerSecond = (metersPerSecond * Constants.driveRatio) / (Constants.wheelDiameter * Math.PI);
        drive.setControl(driveClosedLoop.withVelocity(rotationsPerSecond).withFeedForward(Constants.driveFeedforward.calculate(rotationsPerSecond)));
    }
